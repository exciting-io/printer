...
describe ContentStore do
  ...
  it "stores the file using the id given" do
    ...
    File.exists?(File.expand_path("../../public/temp_content/other-id.html", __FILE__)).must_equal true
  end
  ...
  it "uses a default random id if no ID was given" do
    ...
    File.exists?(File.expand_path("../../public/temp_content/default-id.html", __FILE__)).must_equal true
  end
end